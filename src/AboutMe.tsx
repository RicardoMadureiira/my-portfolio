  ...
  return (
    <section id="sobre" className="about-section w-full py-16 text-lg px-[10%]">
      <div className="max-w-5xl flex flex-col font-medium gap-8">
        ...
        <p className="animate-about text-lg max-md:text-sm leading-relaxed text-slate-300">
          Sou{" "}
          ...
          , com foco no desenvolvimento de interfaces web utilizando{" "}
        ...
        <p className="animate-about text-lg max-md:text-sm leading-relaxed text-slate-300">
          Tenho experiência prática no desenvolvimento de projetos próprios,
          aplicando conceitos de responsividade, organização de componentes e
          boas práticas de código.
        </p>

        <p className="animate-about text-lg max-md:text-sm leading-relaxed text-slate-300">
          Estou em busca da minha primeira oportunidade profissional como
          desenvolvedor Front-End júnior, onde eu possa aprender na prática,
          evoluir tecnicamente e contribuir com o time.
        </p>

        <p className="animate-about text-lg max-md:text-sm leading-relaxed text-slate-300">
          Tenho familiaridade com metodologias ágeis como{" "}
          <span className="text-rose-500 font-medium">Scrum</span> e{" "}
          <span className="text-rose-500 font-medium">Kanban</span>, e procuro
        ...
        <p className="animate-about text-lg max-md:text-sm leading-relaxed text-slate-300">
          ...
          e estou sempre evoluindo tecnicamente para entregar soluções de valor.
        </p>
        ...
        <div className="text-center mt-6 animate-about">
          ...
          >
            <div className="max-w-4xl mx-auto text-center flex flex-col gap-5">
              <p className="text-slate-300 font-medium text-lg max-md:text-sm">
